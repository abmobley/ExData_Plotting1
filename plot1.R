plot1 <- function() {
    ...
    #plot histogram of the Global Active Power readings
    hist(pow_consumption$Global_active_power, col = "red", main = "Global Active Power", xlab = "Global Active Power (kilowatts)")
